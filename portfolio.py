...
if 'profile' not in st.session_state:
    st.session_state.profile = {
        ...
        'email': 'ug2321587@ines.ac.rw',
        'phone': '+250783635561',
        'github': 'https://github.com/Ally-wayne',
        'linkedin': 'https://www.linkedin.com/in/ally-tuyishime-wayne-a40083333',
    }
...
if page == "Home":
    ...
    name = st.text_input("Name: ", "TUYISHIME ALI")
    ...
    with open("research proposal.pdf", "rb") as file:
...
# Projects section
    ...
    with st.expander("📊 e-portofolio"):
        st.write(" type: 'Individual Project',")
        st.write("year 1")
        st.write('discription:''Developed e Portfolio system')
        st.write( 'link:' 'https://github.com/Ally-wayne/e-portofolio-v1.git')
    
    with st.expander("Drought-Risk-Assessment"):
        st.write(" type: 'group work Project',")
        st.write("year 2")
        st.write('discription:''Developed Drought-Risk-Assessment using Python ')
        st.write( 'link:' 'https://github.com/Ally-wayne/AI_Group7_Drought-Risk-Assessment_Assignment2.git')
            

          
    
    with st.expander("🌐 yoga-essential"):
        st.write(" type: 'group Project',")
        st.write("year 3")
        st.write('discription:''Developed yoga-essential system using Python ')
        st.write( 'link:' 'https://github.com/Ally-wayne/yoga-essential.github.io.git')
...
# Contact section
    ...
    st.write("📧 Email: allywaynetuyishime@gmail.com")
    st.write("[🔗 LinkedIn](https://www.linkedin.com/in/ally-tuyishime-wayne-a40083333)")
    st.write("[📂 GitHub](https://github.com/Ally-wayne)")
